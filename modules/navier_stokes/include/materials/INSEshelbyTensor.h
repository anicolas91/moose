...
/**
 * INSEshelbyTensor defines a strain increment and rotation increment, for finite strains.
 */
class INSEshelbyTensor : public DerivativeMaterialInterface<Material>
{
public:
  static InputParameters validParams();

  INSEshelbyTensor(const InputParameters & parameters);
